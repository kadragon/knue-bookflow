...
describe('handleBooksApi', () => {
  it('returns sorted items with derived fields', async () => {
    ...
    const response = await handleBooksApi(env, fakeRepo);
